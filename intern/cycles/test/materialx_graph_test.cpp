...
TEST(materialx_graph, lowers_adjustment_remainder_smoothstep_range_and_remap_forms)
{
  ...
  ASSERT_NE(math["SmoothColor4.Alpha.result"], nullptr);
  EXPECT_EQ(math["SmoothColor4.Alpha.result"]->get_math_type(), NODE_MATH_MULTIPLY);
  ASSERT_NE(math["SmoothVector4.W.result"], nullptr);
  EXPECT_EQ(math["SmoothVector4.W.result"]->get_math_type(), NODE_MATH_MULTIPLY);
